...
class IslandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create island" do
    assert_difference('Island.count') do
      post islands_url, params: { island: { country: @island.country, description: @island.description, location: @island.location, name: @island.name, price: @island.price } }
    end
  ...
  test "should update island" do
    patch island_url(@island), params: { island: { country: @island.country, description: @island.description, location: @island.location, name: @island.name, price: @island.price } }
